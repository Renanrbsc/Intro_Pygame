...
class Ninja(pygame.sprite.Sprite):  # modela um objeto do mundo real
    ...
    def __init__(self):
        ...
        # lista de imagens
        self.images = [pygame.image.load(r'Renangame\ninja\2d-game-sprite-6_001a.png').convert_alpha(),
                       pygame.image.load(r'Renangame\ninja\2d-game-sprite-6_001a.png').convert_alpha(),
                       pygame.image.load(r'Renangame\ninja\2d-game-sprite-6_002a.png').convert_alpha(),
                       pygame.image.load(r'Renangame\ninja\2d-game-sprite-6_002a.png').convert_alpha(),
                       pygame.image.load(r'Renangame\ninja\2d-game-sprite-6_003a.png').convert_alpha(),
                       pygame.image.load(r'Renangame\ninja\2d-game-sprite-6_003a.png').convert_alpha(),
                       pygame.image.load(r'Renangame\ninja\2d-game-sprite-6_004a.png').convert_alpha(),
                       pygame.image.load(r'Renangame\ninja\2d-game-sprite-6_004a.png').convert_alpha(),
                       ]
        ...
        self.image = pygame.image.load(r'Renangame\ninja\2d-game-sprite-6_001a.png').convert_alpha()
...
class Camada1(pygame.sprite.Sprite):
    ...
    def __init__(self, xpos):
        ...
        # Conversao de image inicial
        self.image = pygame.image.load(r'Renangame\layers\ground_3.png').convert_alpha()
...
class Camada2(pygame.sprite.Sprite):
    ...
    def __init__(self, xpos):
        ...
        # Conversao de image inicial
        self.image = pygame.image.load(r'Renangame\layers\ground_2.png').convert_alpha()
        self.image = pygame.transform.scale(self.image,
                                            (largura_tela, camada_altura))  # escala plano para tamanho da tela
        self.rect = self.image.get_rect()
...
plano_fundo = pygame.image.load(r'Renangame\game_background_3\game_background_3.1.png')  # load do plano de fundo
